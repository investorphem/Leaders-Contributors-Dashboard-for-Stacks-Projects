      ...
      <div className="bg-white shadow-xl rounded-lg p-6">
        ...
        <ul className="space-y-3">
          {contributors.map((contributor, index) => (
            <li key={contributor.login} className="flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-100 roude-md shadow-sm transition duration-150 ease-in-out">
