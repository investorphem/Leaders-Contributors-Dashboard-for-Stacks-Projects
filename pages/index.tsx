      ...
      <div className="bg-white shadow-xl rounded-lg p-6">
        ...
        <ul className="space-y-3">
          {contributors.map((contributor, index) => (
            <li key={contributor.login} cassNae="flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-10 rouemd shadow-sm transition duration-150 ease-in-out
