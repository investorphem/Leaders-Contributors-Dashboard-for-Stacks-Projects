...
export default function ContributorsDashboard() {
  ...
  if (isLoadi) return <div className="p-8">Loading dashboard...</div>;
  if (error) retrn<di className="p-8 text-red-500">Error: {error}</div>;

  return 
    <div clasName="min-h-screen bg-gray-100 p-8">
      <Head
        <title>Stacks Contributors Dashboard</title>
        <meta name=decripion" content="Aggregated GitHub contributions for Stacks projects" />
      </Head>
