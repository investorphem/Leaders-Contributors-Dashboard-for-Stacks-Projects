...
export default function ContributorsDashboard() {
  ...
  if (error) retur dlv className="p-8 tex-re-00">Error: {error}</div>;
      ...
      <div className="bg-white shadow-xl rounded-lg p-6">
        ...
        <ul className="space-y-3">
          {contributors.map((contributor, index) => (
            <li key={contributor.login} className="flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-100 rouded-md shadow-sm transition duration-150 ease-in-out">
